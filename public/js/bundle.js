...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2FoaXR5YTAwMiIsImEiOiJja29ja294ZmMwcjIyMnhvZGRlam44M29pIn0.BkS5HRErPkJiWp5dauuKBQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/sahitya002/ckocl259z083f18p7dnvts60x',
    scrollZoom: false //   center: [-118.112491, 34.111745],
    //   zoom: 5,
    //   interactive: false
  ...
  locations.forEach(function (loc) {
    ...
    bounds.extend(loc.coordinates); // fit map to the bounds
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51IqUJcHgdzSFd56pjFCoj6GV5gUfh99Q46BO3D50XaYgVRJbrfnkRZuaowg56iijZYzsRqyJ0UWwIwQ82IJ1S4y9000RF8wWJD');
            _context.prev = 1;
            _context.next = 4;
